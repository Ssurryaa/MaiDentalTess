        ...
        <section id="beranda" className="pt-6 lg:pt-20 px-4 lg:px-20 heroBG">
            <div className="container">
                ...
                <div className="flex justify-center">
                    <div className="absolute -bottom-20 animate__animated animate__fadeInUp card card-compact w-full lg:w-4/5 z-10 bg-white bg-opacity-40 backdrop-blur-md shadow-md">
