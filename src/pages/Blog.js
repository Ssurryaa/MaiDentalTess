                    ...
                    <div className="flex flex-wrap mb-6">
                        ...
                        <div className="w-full lg:w-1/2 mt-4 lg:mt-0 flex justify-center lg:justify-end">
                            ...
                            <div class="relative">
                                ...
                                <input type="search" id="default-search" class="block p-4 pl-10 pr-24 input input-bordered rounded-full input-info bg-white bg-opacity-50 w-full max-w-xs" placeholder="Search" required/>
