              ...
              <div className="w-full lg:w-1/2 flex pb-8 justify-center lg:justify-end">
                <form>   
                  ...
                  <div class="relative">
                      ...
                      <button type="submit" class="absolute right-2 lg:right-2.5 bottom-1.5 px-4 py-2 text-sm rounded-full bg-gradient-to-b from-lightblue to-darkblue text-white transition duration-300 ease-in-out hover:opacity-80 hover:shadow-xl">Search</button>
                  </div>
                </form>
              </div>
            </div>
